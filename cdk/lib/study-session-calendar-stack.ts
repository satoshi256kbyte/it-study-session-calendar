          ...
          bundling: {
            ...
            command: [
              ...
              [
                ...
                'npm ci --production --ignore-engines 2>&1 || npm install --production --ignore-engines 2>&1',
                'echo "Checking if node_modules exists..."',
                'ls -la node_modules/ || echo "node_modules directory not found"',
                'echo "Creating output directory..."',
                'mkdir -p /asset-output/nodejs',
                'echo "Copying node_modules..."',
                'if [ -d "node_modules" ]; then cp -r node_modules /asset-output/nodejs/; else echo "No node_modules to copy"; fi',
                'echo "Copying package.json..."',
                'if [ -f "package.json" ]; then cp package.json /asset-output/nodejs/; else echo "No package.json to copy"; fi',
